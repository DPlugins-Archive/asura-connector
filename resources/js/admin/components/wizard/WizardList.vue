      ...
      <dl class="sm:divide-y sm:divide-gray-200">
        <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          ...
          <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
            {{ provider.site_title }} — <a :href="provider.endpoint" target="_blank"> {{ provider.endpoint }} </a>
          </dd>
        </div>
        <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        ...
        <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Apply on</dt>
          <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
              <div class="pb-1"> <input class="checked:bg-white checked:border-black" type="checkbox" id="color" name="color" v-model="form.color"> <label for="color"> Colors </label> </div>
              <div class="pb-1"> <input class="checked:bg-white checked:border-black" type="checkbox" id="stylesheet" name="stylesheet" v-model="form.stylesheet"> <label for="stylesheet"> Stylesheets </label> </div>
              <div class="pb-1"> <input class="checked:bg-white checked:border-black" type="checkbox" id="setting" name="setting" v-model="form.setting"> <label for="setting"> Oxygen's Settings </label> </div>
              <div class="pb-1"> <input class="checked:bg-white checked:border-black" type="checkbox" id="styleset" name="styleset" v-model="form.styleset"> <label for="styleset"> Stylesets </label> </div>
              <div class="pb-1"> <input class="checked:bg-white checked:border-black" type="checkbox" id="selector" name="selector" v-model="form.selector"> <label for="selector"> Selectors </label> </div>
              <div class="pb-1"> <input class="checked:bg-white checked:border-black" type="checkbox" id="template" name="template" v-model="form.template"> <label for="template"> Templates </label> </div>
              <div class="pb-1"> <input class="checked:bg-white checked:border-black" type="checkbox" id="page" name="page" v-model="form.page"> <label for="page"> Pages </label> </div>
              <div class="pb-1"> <input class="checked:bg-white checked:border-black" type="checkbox" id="class" name="class" v-model="form.class"> <label for="class"> Classes </label> </div>
          </dd>
        </div>
        <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
  ...
  methods: {
    loadProvider(id) {
      axios
        .get(thelostasura.ajax_url, {
          params: {
            action: `${thelostasura.module_id}_get_provider`,
    ...
    loadTermsList(id) {
      axios
        .get(thelostasura.ajax_url, {
          params: {
            action: `${thelostasura.module_id}_list_terms`,
            _wpnonce: thelostasura.nonce,
            provider_id: id ? id : this.provider_id,
          },
        })
    ...
    installColors(id, license_id, term_slug) {
      ...
      axios
        .post(
          ...
          new URLSearchParams({
            _wpnonce: thelostasura.nonce,
            action: `${thelostasura.module_id}_wizard_colors`,
    ...
    installStylesheets(id, license_id, term_slug) {
      ...
      axios
        .post(
          ...
          new URLSearchParams({
            _wpnonce: thelostasura.nonce,
            action: `${thelostasura.module_id}_wizard_stylesheets`,
            overwrite: this.form.overwrite,
            provider_id: id ? id : this.provider_id,
            license_id: license_id,
            term_slug: term_slug,
    ...
    installSettings(id, license_id, term_slug) {
      ...
      axios
        .post(
          ...
          new URLSearchParams({
            _wpnonce: thelostasura.nonce,
            action: `${thelostasura.module_id}_wizard_settings`,
            overwrite: this.form.overwrite,
            provider_id: id ? id : this.provider_id,
            license_id: license_id,
            term_slug: term_slug,
    ...
    installStylesets(id, license_id, term_slug) {
      ...
      axios
        .post(
          ...
          new URLSearchParams({
            _wpnonce: thelostasura.nonce,
            action: `${thelostasura.module_id}_wizard_stylesets`,
            overwrite: this.form.overwrite,
            provider_id: id ? id : this.provider_id,
            license_id: license_id,
            term_slug: term_slug,
    ...
    installSelectors(id, license_id, term_slug) {
      ...
      axios
        .post(
          ...
          new URLSearchParams({
            _wpnonce: thelostasura.nonce,
            action: `${thelostasura.module_id}_wizard_selectors`,
            overwrite: this.form.overwrite,
            provider_id: id ? id : this.provider_id,
            license_id: license_id,
            term_slug: term_slug,
    ...
    installTemplates(id, license_id, term_slug) {
      ...
      axios
        .post(
          ...
          new URLSearchParams({
            _wpnonce: thelostasura.nonce,
            action: `${thelostasura.module_id}_wizard_templates`,
            overwrite: this.form.overwrite,
            provider_id: id ? id : this.provider_id,
            license_id: license_id,
            term_slug: term_slug,
    ...
    installPages(id, license_id, term_slug) {
      ...
      axios
        .post(
          ...
          new URLSearchParams({
            _wpnonce: thelostasura.nonce,
            action: `${thelostasura.module_id}_wizard_pages`,
            overwrite: this.form.overwrite,
            provider_id: id ? id : this.provider_id,
            license_id: license_id,
            term_slug: term_slug,
    ...
    installClasses(id, license_id, term_slug) {
      ...
      axios
        .post(
          ...
          new URLSearchParams({
            _wpnonce: thelostasura.nonce,
            action: `${thelostasura.module_id}_wizard_classes`,
            overwrite: this.form.overwrite,
            provider_id: id ? id : this.provider_id,
            license_id: license_id,
            term_slug: term_slug,
